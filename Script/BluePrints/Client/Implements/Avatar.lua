...
local AvatarAttr = {
  ...
  WeitaSex = prop.prop("Int", "client save cross", 0),
  ...
  WeaponSkinLevels = prop.prop("Int2IntDict", "client save"),
  OwnedMountSkins = prop.prop("Int2IntDict", "client save"),
  QuestChains = prop.prop("Quest.QuestChains", "client save"),
  QuestChapters = prop.prop("Quest.QuestChapterDict", "client save"),
  QuestBacktracks = prop.prop("QuestBacktrack.QuestBacktrackDataDict", "client save"),
  EventReviewPages = prop.prop("EventReview.EventReviewPageDict", "client save"),
  Clues = prop.prop("Clue.ClueDict", "client save"),
  ClueRewards = prop.prop("Int2BoolDict", "client save"),
  ...
  PackageRegisterMailHasGot = prop.prop("Bool", "client save", false),
  ...
  ModArchiveRewards = prop.prop("Int2IntListDict", "client save"),
  ...
  bAutoPhantomForBigWorld = prop.prop("Bool", "client save", true),
  ...
  ShopItem2Order = prop.prop("Int2StrDict", "client save"),
  ShopFirstBonusOrders = prop.prop("Str2IntDict", "client save"),
  ...
  StoryVariableOverrideStates = prop.prop("StoryVariable.StoryVariableOverrideState", "save"),
  ...
  ShowPet = prop.prop("Bool", "client save cross", true),
  ...
  MonthlyCheck = prop.prop("MonthlyCheck.MonthlyCheck", "client save"),
  MoneyTree = prop.prop("MoneyTree.MoneyTreeDict", "client save"),
  FreshmenGift = prop.prop("FreshmenGift.FreshmenGift", "client save"),
  ...
  BlackMatch = prop.prop("Int", "client save", -1),
  ...
  AppearanceCollects = prop.prop("AppearanceCollect.AppearanceCollectDict", "client save"),
  AppearanceScoreRewards = prop.prop("Int2IntDict", "client save", {}),
  AppearanceScores = prop.prop("Str2IntDict", "client save", {}),
  ...
  BackgroundList = prop.prop("IntList", "client save", {}),
  PersonalInfoSceneList = prop.prop("IntList", "client save", CommonConst.DefaultPersonalInfoScene),
  PersonalInfoGestureList = prop.prop("IntList", "client save", CommonConst.DefaultPersonalInfoGesture),
  PersonalInfoStickList = prop.prop("IntList", "client save", {}),
  ...
  DouyinSentRewards = prop.prop("Str2IntDict", "client save", {}),
  ...
  WeaponVerifys = prop.prop("WeaponVerify.WeaponVerifyDict", "client save"),
  ...
  MobileHudPlans = prop.prop("BytesList", "client save"),
  ...
  AutoAgreeInvite = prop.prop("Bool", "client save", true),
  ...
  AsyncCombats = prop.prop("AsyncCombat.AsyncCombatDict", "client save"),
  RequestJoinGuildTime = prop.prop("Int2IntDict", "client save", {}),
  LastQuitGuildTime = prop.prop("Int", "client save", 0),
  LastQuitGuildLevel = prop.prop("Int", "client save", 0),
  RejectedJoinGuildRecord = prop.prop("Int2IntDict", "client save", {}),
  GuildInviteRecord = prop.prop("Int2IntDict", "client save", {}),
  GuildId = prop.prop("Int", "client save", 0),
  GuildInfo = prop.prop("Guild.GuildInfo", "client"),
  GuildSeatWeaponPlans = prop.prop("GuildSeat.GuildSeatPlanList", "client save", {}),
  GuildSeatCharacterPlans = prop.prop("GuildSeat.GuildSeatPlanList", "client save", {}),
  GuildSeatActionPlans = prop.prop("GuildSeat.GuildSeatPlanList", "client save", {}),
  GuildSeatLikeCounts = prop.prop("Int", "client save", 0),
  GuildSeatCopyCounts = prop.prop("Int", "client save", 0),
  GuildSeatLikedRecords = prop.prop("Str2IntDict", "client save", {}),
  GuildSeatCopiedRecords = prop.prop("Str2IntDict", "client save", {}),
  GuildLastWeekActivityLevel = prop.prop("Int", "save client", 0),
  GuildActivityLevel = prop.prop("Int", "save client", 0),
  GuildActivityLevelRewardRecord = prop.prop("Int2IntDict", "save client", {}),
  GuildActivityLevelRewardLevel = prop.prop("Int", "save client", 1),
  GuildDailyTaskActivityPoint = prop.prop("Int", "save", 0),
  GuildChatOpen = prop.prop("Bool", "client save", true),
  GuildChats = prop.prop("Chat.ChatDict", "client save"),
  CharacterAttributeSwitch = prop.prop("Int2IntDict", "client save", {}),
  PopupPack = prop.prop("PopupPack.PopupPackDict", "client save", {}),
  LoginPopUpRecords = prop.prop("LoginPopUp.LoginPopUpRecordDict", "client save", {}),
  LoginPopUpNoPopSevenDaysExpireTime = prop.prop("Int2IntDict", "client save", {}),
  AppearanceCollectEvent = prop.prop("AppearanceCollectEvent.AppearanceCollectEventDict", "client save", {}),
  RaceLotteryInfo = prop.prop("RaceLottery.RaceLotteryInfo", "client save"),
  AccssoryScore = prop.prop("Int", "client save", 0),
  PermRewardCollections = prop.prop("Int2BoolDict", "client save", {}),
  HyperCardLevelMax = prop.prop("Int", "client save", -1),
  GestureItemPanel = prop.prop("Int2IntListDict", "client save", {}),
  TreasureHuntManualInfo = prop.prop("TreasureHunt.TreasureHuntManualInfo", "client save", {}),
  TeamHallId = prop.prop("Int", "client", 0),
  TeamRequestList = prop.prop("TeamRequest.TeamRequestList", "client")
}
return AvatarAttr
