...
local AvatarAttr = {
  ...
  RougePro = prop.prop("RougeLikeInfo.RougeProInfo", "client save cross"),
  ...
  GuildBossData = prop.prop("GuildBoss.AvatarGuildBossData", "client save"),
  CurrentGuildOnlineId = prop.prop("Int", "client save", 0),
  GuildOnlinePlayerInfo = prop.prop("Bytes", "save", ""),
