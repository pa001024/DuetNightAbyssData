...
Avatar.__Component__ = {
  ...
  "BluePrints.Client.Entities.Components.EventReviewMgr",
  "BluePrints.Client.Entities.Components.ClueMgr",
  ...
  "BluePrints.Client.Entities.Components.TeamHall",
  ...
  "BluePrints.Client.Entities.Components.FreshmenGiftComp",
  "BluePrints.Client.Entities.Components.DailyLogin",
  "BluePrints.Client.Entities.Components.MonthlyCheckComp",
  "BluePrints.Client.Entities.Components.MoneyTreeComp",
...
function Avatar:ShowCustomTip(text)
  UIManager(self):ShowUITip("CommonToastMain", text, 2)
end
