...
function M:Construct()
  ...
  self.Button_Star:BindEventOnClicked(self, self.OnBtnStarReleased)
  FriendController:OverrideButtonSound(self.Button_Remarks, "event:/ui/common/click_mid", nil)
  self.Button_Remarks:BindEventOnClicked(self, self.OnBtnRemarksReleased)
  FriendController:OverrideButtonSound(self.Button_BlackList, "event:/ui/common/click_mid", nil)
  self.Button_BlackList:BindEventOnClicked(self, self.OnBtnBlackListReleased)
  FriendController:OverrideButtonSound(self.Button_Remove, "event:/ui/common/click_mid", nil)
  self.Button_Remove:BindEventOnClicked(self, self.OnBtnRemoveReleased)
...
function M:Destruct()
  self.Button_Star:UnBindEventOnClicked(self, self.OnBtnStarReleased)
  self.Button_Remarks:UnBindEventOnClicked(self, self.OnBtnRemarksReleased)
  self.Button_BlackList:UnBindEventOnClicked(self, self.OnBtnBlackListReleased)
  self.Button_Remove:UnBindEventOnClicked(self, self.OnBtnRemoveReleased)
end
