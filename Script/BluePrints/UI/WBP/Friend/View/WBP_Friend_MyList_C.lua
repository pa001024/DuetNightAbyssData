...
function M:Construct()
  ...
  self.Button_BlackList:BindEventOnClicked(self, self.OpenFriendDialogWindow, FriendCommon.FriendDialogType.BlackList)
  self.Button_Request:SetText(GText("UI_Friend_FriendRequest"))
  self.Button_Request:SetGamePadImg("Y")
  self.Button_Request:BindEventOnClicked(self, self.OpenFriendDialogWindow, FriendCommon.FriendDialogType.FriendRequest)
...
function M:Destruct()
  self.Button_BlackList:UnBindEventOnClicked(self, self.OpenFriendDialogWindow)
  self.Button_Request:UnBindEventOnClicked(self, self.OpenFriendDialogWindow)
