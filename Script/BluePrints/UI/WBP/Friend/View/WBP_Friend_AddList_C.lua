...
function M:Construct()
  ...
  self.Button_Search:BindEventOnClicked(self, self.OnSearchReleased)
  ...
  self.Button_Refresh:BindEventOnClicked(self, self.OnRefreshReleased)
...
function M:Destruct()
  self.Button_Refresh:UnBindEventOnClicked(self, self.OnRefreshReleased)
  self.Button_Search:UnBindEventOnClicked(self, self.OnSearchReleased)
