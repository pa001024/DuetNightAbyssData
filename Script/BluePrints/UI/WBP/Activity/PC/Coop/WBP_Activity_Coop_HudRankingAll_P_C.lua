...
function M:UpdateTextKey()
  if self.Expanded then
    self.TextKey:SetText(GText("UI_CTL_Fold"))
  else
    self.TextKey:SetText(GText("UI_AsyncCombat_Expand"))
  end
end
...
function M:UpdateExpansionTipVisibility()
  if self.bNotShowExpansionTip then
    ...
    self.Com_KeyText:SetVisibility(UIConst.VisibilityOp.Collapsed)
    self.TextKey:SetVisibility(UIConst.VisibilityOp.Collapsed)
  else
    self.Com_KeyImg:SetVisibility(UIConst.VisibilityOp.SelfHitTestInvisible)
    self.Com_KeyText:SetVisibility(UIConst.VisibilityOp.SelfHitTestInvisible)
    self.TextKey:SetVisibility(UIConst.VisibilityOp.SelfHitTestInvisible)
  end
end
