...
function M:StartTeleport()
  ...
  local TeleportLocation = UE4.FVector(self.TargetLocation.X, self.TargetLocation.Y, self.TargetLocation.Z + CapsuleHalfHeight)
  PlayerCharacter:K2_TeleportTo(TeleportLocation, self.TargetRotation, false, nil, false)
