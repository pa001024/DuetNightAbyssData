...
return ReadOnly("BattlePassMain", {
  ...
  [100009] = {
    ...
    BPRewardTyppe = "Skin",
    BattlePassEndTime = LocalTimeProxy(1782766799),
    BattlePassId = 100009,
    BattlePassStartTime = LocalTimeProxy(1780304401),
    BattlePassTitle = "UI_BPTitle_100009",
    LevelExp = 500,
    LevelLimit = 1000,
    LoopFreeRewardId = T.RT_5,
    LoopPaidRewardId = T.RT_6,
    ...
    PetClaimLevel = 30,
    PetId = T.RT_1,
    PreviewSkinSeries = "BP_05",
    Rank2GoodsId = "com.hero.dna.Pay_BattlePassRank2",
    Rank2RewardView = 10000968,
    Rank2to3GoodsId = "com.hero.dna.Pay_BattlePassRank2to3",
    Rank3GoodsId = "com.hero.dna.Pay_BattlePassRank3",
    Rank3Reward = 100009,
    Rank3RewardView = 100009,
    RewardMailId = 100401,
    SkyBoxColor = T.RT_4,
    WeeklyMaxExp = 8000
  },
  [100010] = {
    ...
    BattlePassEndTime = LocalTimeProxy(1785142799),
    BattlePassId = 100010,
    BattlePassStartTime = LocalTimeProxy(1782766800),
    BattlePassTitle = "UI_BPTitle_100010",
    LevelExp = 500,
    LevelLimit = 1000,
    LoopFreeRewardId = T.RT_5,
    LoopPaidRewardId = T.RT_6,
    ...
    PetId = T.RT_1,
    Rank2GoodsId = "com.hero.dna.Pay_BattlePassRank2",
    Rank2RewardView = 10001068,
    Rank2to3GoodsId = "com.hero.dna.Pay_BattlePassRank2to3",
    Rank3GoodsId = "com.hero.dna.Pay_BattlePassRank3",
    Rank3Reward = 100010,
    Rank3RewardView = 100010,
    RewardMailId = 100401,
    SkyBoxColor = T.RT_4,
    WeaponSkinId = 3010408,
    WeeklyMaxExp = 8000
  },
  [100011] = {
    BPRewardTemplateID = 100011,
    BPRewardTyppe = "Skin",
    BattlePassEndTime = LocalTimeProxy(1788771600),
    BattlePassId = 100011,
    BattlePassStartTime = LocalTimeProxy(1785142800),
    BattlePassTitle = "UI_BPTitle_100011",
    LevelExp = 500,
    LevelLimit = 1000,
    LoopFreeRewardId = T.RT_5,
    LoopPaidRewardId = T.RT_6,
    ...
    PetClaimLevel = 30,
    PetId = T.RT_1,
    PreviewSkinSeries = "BP_06_1",
    Rank2GoodsId = "com.hero.dna.Pay_BattlePassRank2",
    Rank2RewardView = 10001168,
    Rank2to3GoodsId = "com.hero.dna.Pay_BattlePassRank2to3",
    Rank3GoodsId = "com.hero.dna.Pay_BattlePassRank3",
    Rank3Reward = 100011,
    Rank3RewardView = 100011,
    RewardMailId = 100401,
    SkyBoxColor = T.RT_4,
    WeeklyMaxExp = 8000
  }
