...
class RewardViewProcessor(BaseProcessor):
    def __init__(self, data_loader):
        super().__init__(data_loader)
        self.file_type = "RewardView"
        self.reward_data = data_loader.load_json("RewardView.json")
    ...
    def process_item(self, item_data, language, processed_ids=None):
        ...
        # 获取奖励ID
        reward_id = item_data.get("RewardViewId", 0)
        if not reward_id:
            return None
